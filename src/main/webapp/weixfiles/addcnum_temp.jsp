...
<body>
	...
	<section class="main">
		<!-- 输入车牌号[[ -->
		<form method="post" action="${redircturl}&openid=${openid}&comid=${comid}" role="form" class="form lpn-form" id="carnumberform">
			<fieldset>
				...
				<div class="form-tips">&nbsp;<div id="text">将保存此车牌号，下次无需输入</div></div>
