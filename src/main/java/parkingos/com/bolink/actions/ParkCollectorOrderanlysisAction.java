...
public class ParkCollectorOrderanlysisAction {
    ...
    * */
    ...
    public String exportExcel(HttpServletRequest request, HttpServletResponse response){
        ...
        String headers[] =  { "收费员", "实收金额", "实收金额", "实收金额", "实收金额","减免金额" } ;
        String dataType []={"STR","STR","STR","STR","STR"};
        String[] subHeads = new String[] {"现金预付", "现金结算", "电子结算", "合计"};
        String[] headnum = new String[] { "1,2,0,0", "1,1,1,4","1,2,5,5"};
        String[] subheadnum = new String[] { "2,2,1,1", "2,2,2,2", "2,2,3,3","2,2,4,4"};
        ExportExcelUtil excelUtil = new ExportExcelUtil(title, headers, sheeatName, dataType, subHeads, headnum, subheadnum, new int[]{0,5});
        String fname = "收费员日报";
