...
public class ParkInfoServiceImpl implements ParkInfoService {
    ...
    public JSONObject selectResultByConditions(Map<String, String> reqmap) {
        JSONObject result = supperSearchService.supperSearch(new ComInfoTb(),reqmap);
        ...
        Map searchMap = supperSearchService.getBaseSearch(new ComInfoTb(),reqmap);
