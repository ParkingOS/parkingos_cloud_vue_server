...
//        prepayCardTb.setGroupId(groupid);
        ...
        int count =0;
        List<PrepayCardTb> list =null;
        List<Map<String, Object>> resList =new ArrayList<Map<String, Object>>();
        Map searchMap = supperSearchService.getBaseSearch(prepayCardTb,reqParameterMap);
        if(searchMap!=null&&!searchMap.isEmpty()){
            PrepayCardTb t1 =(PrepayCardTb)searchMap.get("base");
            ...
            if(count>0){
                ...
                if (list != null && !list.isEmpty()) {
                    for (PrepayCardTb whiteListTb1 : list) {
                        OrmUtil<PrepayCardTb> otm = new OrmUtil<>();
