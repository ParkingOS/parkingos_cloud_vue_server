...
//  var Domain = 'http://test.bolink.club/cloud';
    var Domain = 'http://yun.bolink.club/cloud';
    ...
    //修改源码2018/5/25
    var ckplayerJS = Domain + '/1.3/ckplayer/ckplayer.js';
    var ckplayerSWF = Domain + '/1.3/ckplayer/ckplayer.swf';
    var m3u8SWF = Domain + '/1.3/ckplayer/m3u8.swf';
    var hlsJS = Domain + '/1.3/hls.min.js';
